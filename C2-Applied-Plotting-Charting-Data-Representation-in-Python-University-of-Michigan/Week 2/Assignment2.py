...
#display the minimum and maximum temperature for a range of dates 
#you will demonstrate procedure of composite charts, by overlaying a scatter plot of record breaking data for a given year. 
